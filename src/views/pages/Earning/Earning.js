...
const CustomHeader = props => {
  ...
  return ( 
    <Space>     
        <><Col span={4} md={{ flex: '50%' }} xl={{ flex: '50%' }} xs={{ flex: '50%' }}>
          <DatePicker onChange={onChange} size='150' />
        </Col> 
        <Col span={4}  md={{ flex: '30%' }} xl={{ flex: '30%' }}> 
          <Select
            defaultValue="lucy"
            style={{ width: 120 }}
            onChange={handleChange}
            options={[
              { value: 'jack', label: '812' },
              { value: 'lucy', label: '329' },
              { value: 'Yiminghe', label: '514' },
              { value: 'disabled', label: 'AI' },
            ]} />
        </Col>
        <Col span={4} md={{ flex: '30%' }} xl={{ flex: '30%' }}> 
          ...
          Print as CSV
        </Button><Button type="default" icon={<ImportOutlined />}>
          Import CSV
        </Button><Button type="default" icon={<PlusOutlined />}>
          Create
        </Button></> 
    </Space>   
